          ...
          <div className="flex items-center justify-between py-4 mb-2 cursor-pointer active:bg-white/5 relative z-0" onClick={() => triggerVipModal("Solicitações de Seguir", "Veja quem quer seguir você com o acesso completo.")}>
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 bg-[#FF3040] text-[10px] font-black text-white w-[19px] h-[19px] flex items-center justify-center rounded-full border-2 border-black shadow-[0_0_8px_rgba(255,48,64,0.4)]">
                  7
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 flex flex-col">
                  <p className="text-gray-300 text-[13px] leading-[1.4] font-normal">
                    <span className="font-black italic animate-text-shimmer bg-[linear-gradient(to_right,#FFD600,white,#FFE500,#FFD600)] bg-[length:400%_auto] bg-clip-text text-transparent">Stories vistos</span> por <span className="font-black italic animate-text-shimmer bg-[linear-gradient(to_right,#FFD600,white,#FFE500,#FFD600)] bg-[length:400%_auto] bg-clip-text text-transparent">@{username}</span>, <span className="font-black italic animate-text-shimmer bg-[linear-gradient(to_right,#FFD600,white,#FFE500,#FFD600)] bg-[length:400%_auto] bg-clip-text text-transparent">Desbloqueie</span> para ver <span className="font-black italic animate-text-shimmer bg-[linear-gradient(to_right,#FFD600,white,#FFE500,#FFD600)] bg-[length:400%_auto] bg-clip-text text-transparent">todos</span>.
                  </p>
                </div>
              </div>
            </div>
